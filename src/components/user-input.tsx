...
export default function UserInput() {
  ...
  function calculatePrice(
    ...
    const sortedBrackets = Object.keys(priceBrackets)
      .map(Number)
      .sort((a, b) => a - b);
  ...
  return (
    <div className="grid w-full gap-1.5 container mb-10">
      <div className="sm:flex justify-between max-w-xs">
        <p className="text-2xl font-semibold underline">Estimated Cost:</p>
        <p className="text-xl font-semibold">${price.toFixed(5)}</p>
      </div>
      <div className="flex items-center">
        <Label htmlFor="message-2">Input</Label>
